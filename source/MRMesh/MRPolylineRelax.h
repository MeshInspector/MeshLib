...
MRMESH_API bool relax( Polyline2& polyline, const PolylineRelaxParams& params = {}, ProgressCallback cb = {} );
...
/// \return true if was finished successfully, false if was interrupted by progress callback
MRMESH_API bool relaxKeepArea( Polyline2& polyline, const PolylineRelaxParams& params = {}, ProgressCallback cb = {} );
