...
MRVIEWER_API void setShowLeadingZero( bool show, WriteToSettings writeToConfig = WriteToSettings::yes );
...
void setThousandsSeparator( char ch, WriteToSettings writeToConfig = WriteToSettings::yes );
...
MRVIEWER_API void setUiLengthUnit( std::optional<LengthUnit> unit, bool setPreferredLeadingZero, WriteToSettings writeToConfig = WriteToSettings::yes );

// Angle:

[[nodiscard]] MRVIEWER_API DegreesMode getDegreesMode();
MRVIEWER_API void setDegreesMode( DegreesMode mode, bool setPreferredPrecision, WriteToSettings writeToConfig = WriteToSettings::yes );
...
MRVIEWER_API void setUiLengthPrecision( int precision, WriteToSettings writeToConfig = WriteToSettings::yes );

[[nodiscard]] MRVIEWER_API int getUiAnglePrecision();
MRVIEWER_API void setUiAnglePrecision( int precision, WriteToSettings writeToConfig = WriteToSettings::yes );
