...
class RibbonSceneUnselectAll : public RibbonMenuItem, public SceneStateAtLeastCheck<1, Object, NoVisualRepresentationCheck>
{
public:
...
class RibbonSceneRename : public RibbonMenuItem, public SceneStateExactCheck<1, Object, NoVisualRepresentationCheck>
{
public:
    RibbonSceneRename();
...
class RibbonSceneRemoveSelected : public RibbonMenuItem, public SceneStateAtLeastCheck<1, Object, NoVisualRepresentationCheck>
{
public:
