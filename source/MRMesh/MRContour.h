...
MR_BIND_TEMPLATE( Contour2<std::vector<float >> copyContours( const Contour2<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour2<std::vector<float >> copyContours( const Contour2<std::vector<double>> & from ) )
MR_BIND_TEMPLATE( Contour2<std::vector<float >> copyContours( const Contour3<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour2<std::vector<float >> copyContours( const Contour3<std::vector<double>> & from ) )
MR_BIND_TEMPLATE( Contour2<std::vector<double>> copyContours( const Contour2<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour2<std::vector<double>> copyContours( const Contour2<std::vector<double>> & from ) )
MR_BIND_TEMPLATE( Contour2<std::vector<double>> copyContours( const Contour3<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour2<std::vector<double>> copyContours( const Contour3<std::vector<double>> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<float >> copyContours( const Contour2<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<float >> copyContours( const Contour2<std::vector<double>> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<float >> copyContours( const Contour3<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<float >> copyContours( const Contour3<std::vector<double>> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<double>> copyContours( const Contour2<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<double>> copyContours( const Contour2<std::vector<double>> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<double>> copyContours( const Contour3<std::vector<float >> & from ) )
MR_BIND_TEMPLATE( Contour3<std::vector<double>> copyContours( const Contour3<std::vector<double>> & from ) )
