...
MRMESH_API VoidOrErrStr parseCoordinate( const std::string_view& str, Vector3f& v );
MRMESH_API VoidOrErrStr parseCoordinate( const std::string_view& str, Vector3f& v, char prefix );
