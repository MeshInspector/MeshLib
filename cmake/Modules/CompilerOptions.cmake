...
if(APPLE)
  option(MESHLIB_MACOS_FORCE_SYSTEM_LIBCXX "Force use system libc++ on macOS" OFF)
  if(MESHLIB_MACOS_FORCE_SYSTEM_LIBCXX AND CMAKE_CXX_COMPILER_ID STREQUAL "Clang")
    execute_process(
