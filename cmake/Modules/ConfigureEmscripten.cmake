...
string(JOIN " " MESHLIB_EMSCRIPTEN_PORT_FLAGS
...
string(JOIN " " MESHLIB_EMSCRIPTEN_LINK_FLAGS
...
IF(MR_EMSCRIPTEN_MIMALLOC)
  set(MESHLIB_EMSCRIPTEN_LINK_FLAGS "${MESHLIB_EMSCRIPTEN_LINK_FLAGS} -s MALLOC=mimalloc")
ENDIF()

IF(MR_EMSCRIPTEN_SINGLETHREAD)
  set(MESHLIB_EMSCRIPTEN_LINK_FLAGS "${MESHLIB_EMSCRIPTEN_LINK_FLAGS} -s ENVIRONMENT=web,node")
ELSE()
  ...
  ENDIF()
  string(JOIN " " MESHLIB_EMSCRIPTEN_LINK_FLAGS ${MESHLIB_EMSCRIPTEN_LINK_FLAGS}
...
string(JOIN " " CMAKE_CXX_FLAGS ${CMAKE_CXX_FLAGS} ${MESHLIB_EMSCRIPTEN_PORT_FLAGS})
string(JOIN " " CMAKE_EXE_LINKER_FLAGS ${CMAKE_EXE_LINKER_FLAGS} ${MESHLIB_EMSCRIPTEN_LINK_FLAGS})
string(JOIN " " MESHLIB_EMSCRIPTEN_CXX_FLAGS ${MESHLIB_EMSCRIPTEN_CXX_FLAGS} ${MESHLIB_EMSCRIPTEN_PORT_FLAGS})
string(JOIN " " MESHLIB_EMSCRIPTEN_EXE_LINKER_FLAGS ${MESHLIB_EMSCRIPTEN_EXE_LINKER_FLAGS} ${MESHLIB_EMSCRIPTEN_LINK_FLAGS})
