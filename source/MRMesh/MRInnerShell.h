...
/// if squared distance to the point is more than \param maxAbsDist, it will not be considered as shell vertex
...
/// Vertices with squared distances to the mesh more than \param maxAbsDist will not be considered as shell vertices
