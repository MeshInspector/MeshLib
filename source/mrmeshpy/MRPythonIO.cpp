...
{
    m.def( "loadPoints",
        MR::decorateExpected( ( Expected<PointCloud, std::string>( * )( const std::filesystem::path&, AffineXf3f*, VertColors*, ProgressCallback ) )& MR::PointsLoad::fromAnySupportedFormat ),
        pybind11::arg( "path" ), pybind11::arg( "outXf" ) = nullptr, pybind11::arg( "colors" ) = nullptr, pybind11::arg( "callback" ) = ProgressCallback{},
