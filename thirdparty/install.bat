...
set VCPKG_BINARY_SOURCES=clear;x-aws,s3://vcpkg-export/2023.04.15/test/,write;

vcpkg install --overlay-triplets "%~dp0vcpkg\triplets" --x-abi-tools-use-exact-versions --debug
