...
MR_BIND_TEMPLATE( Contour2<float > copyContour( const Contour2<float > & from ) )
MR_BIND_TEMPLATE( Contour2<float > copyContour( const Contour2<double> & from ) )
MR_BIND_TEMPLATE( Contour2<float > copyContour( const Contour3<float > & from ) )
...
MR_BIND_TEMPLATE( Contour2<double> copyContour( const Contour2<double> & from ) )
MR_BIND_TEMPLATE( Contour2<double> copyContour( const Contour3<float > & from ) )
MR_BIND_TEMPLATE( Contour2<double> copyContour( const Contour3<double> & from ) )
MR_BIND_TEMPLATE( Contour3<float > copyContour( const Contour2<float > & from ) )
MR_BIND_TEMPLATE( Contour3<float > copyContour( const Contour2<double> & from ) )
MR_BIND_TEMPLATE( Contour3<float > copyContour( const Contour3<float > & from ) )
...
MR_BIND_TEMPLATE( Contour3<double> copyContour( const Contour2<double> & from ) )
MR_BIND_TEMPLATE( Contour3<double> copyContour( const Contour3<float > & from ) )
MR_BIND_TEMPLATE( Contour3<double> copyContour( const Contour3<double> & from ) )

MR_BIND_TEMPLATE( std::vector<Contour2<float >> copyContours( const std::vector<Contour2<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour2<float >> copyContours( const std::vector<Contour2<double>> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour2<float >> copyContours( const std::vector<Contour3<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour2<float >> copyContours( const std::vector<Contour3<double>> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour2<double>> copyContours( const std::vector<Contour2<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour2<double>> copyContours( const std::vector<Contour2<double>> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour2<double>> copyContours( const std::vector<Contour3<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour2<double>> copyContours( const std::vector<Contour3<double>> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<float >> copyContours( const std::vector<Contour2<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<float >> copyContours( const std::vector<Contour2<double>> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<float >> copyContours( const std::vector<Contour3<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<float >> copyContours( const std::vector<Contour3<double>> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<double>> copyContours( const std::vector<Contour2<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<double>> copyContours( const std::vector<Contour2<double>> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<double>> copyContours( const std::vector<Contour3<float >> & from ) )
MR_BIND_TEMPLATE( std::vector<Contour3<double>> copyContours( const std::vector<Contour3<double>> & from ) )
