...
/// Shows 3 edit boxes for editing of local direction coordinates;
/// \param directionEditDragging must be initialized with zero, used to append only one history action on start dragging;
