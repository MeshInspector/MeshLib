...
$($1__CombinedHeaderOutput): $($1__InputFiles) | $(TEMP_OUTPUT_DIR)
	...
	$(if $(is_py),\
		$(call,### PROBE: this branch reverts the MB_PB11_ADJUST_NAMES PCH-source-include fix to reproduce the macro-mismatch error and capture diagnostics around it.)\
