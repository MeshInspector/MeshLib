...
/// each returned line segment is oriented to have the region to the left, and it passes in a triangle adjacent to original boundary vertex of given region
