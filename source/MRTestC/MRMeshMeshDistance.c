...
void testMeshMeshDistance( void )
{
    ...
    MRMeshMeshDistanceResult d11 = findDistance( &wholeSphere1, &wholeSphere1, NULL, FLT_MAX );
    ...
    MRMeshMeshDistanceResult d1z = findDistance( &wholeSphere1, &wholeSphere1, &zShift, FLT_MAX );
    ...
    MRMeshMeshDistanceResult d12 = findDistance( &wholeSphere1, &wholeSphere2, NULL, FLT_MAX );
