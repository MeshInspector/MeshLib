...
MR_CONCAT( MR, ClassName )* MR_CONCAT( MR_CONCAT( mr, ClassName ), NewSized )(size_t size)               \
{                                                                                            \
    return reinterpret_cast<MR_CONCAT( MR, ClassName )*>( new vector_wrapper<Type>( std::vector<Type>(size) ) ); \
}                                                                                                            \
