...
if [ -d /usr/lib/python3.8 ]; then
 ...
 sudo ln -sf /usr/local/lib/MeshLib/mrmeshpy.so /usr/lib/python3.8/site-packages/mrmeshpy.so
 sudo ln -sf /usr/local/lib/MeshLib/mrmeshnumpy.so /usr/lib/python3.8/site-packages/mrmeshnumpy.so
 sudo ln -sf /usr/local/lib/MeshLib/mrealgorithmspy.so /usr/lib/python3.8/site-packages/mrealgorithmspy.so
