# Mesh Structure Overview {#MeshStructureOverview}
...
### Topology
Topology in Meshlib is represented as "Half-Edge structure" which means that core primitives are "Half-Edges". <br/>
"Half-Edges" are called "Half" because a pair of half edges represent one "Oriented Edge" (one for origin vertex and left face, and the other for destination vertex and right face) <br/>
...
![](mesh_structure/navigation_base.png)

![](mesh_structure/navigation_hole.png)
