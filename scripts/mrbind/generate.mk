...
INPUT_DIRS := $(addprefix $(makefile_dir)/../../source/,MRMesh MRIOExtras MRSymbolMesh MRVoxels) $(makefile_dir)
...
LINKER_FLAGS := $(EXTRA_LDFLAGS) -L$(DEPS_LIB_DIR) $(PYTHON_LDFLAGS) -L$(MESHLIB_SHLIB_DIR) -lMRMesh -lMRIOExtras -lMRSymbolMesh -lMRVoxels -shared $(call load_file,$(makefile_dir)/linker_flags.txt)
NUM_FRAGMENTS := 4
