...
/// expands the region on given metric value. returns false if callback also returns false
...
/// shrinks the region on given metric value. returns false if callback also returns false
