    ...
    internal class MeshTests
    {
        ...
        public void TestSaveLoadToObj()
        {
            Assert.DoesNotThrow(() =>
            {
                ...
                Assert.That(loadedObjs.at(0).mesh.points.size() == 8);
                Assert.That(loadedObjs.at(0).name == "Cube");
                Assert.That(loadedObjs.at(0).xf.b.x == 0.0f);

                Assert.That(loadedObjs.at(1).mesh.points.size() == 100);
                Assert.That(loadedObjs.at(1).name == "LongSphereName");
                Assert.That(loadedObjs.at(1).xf.b.x == 0.0f);
                ...
                Assert.That(loadedObjs.at(0).mesh.points.size() == 8);
                Assert.That(loadedObjs.at(0).name == "Cube");
                Assert.That(loadedObjs.at(0).xf.b.x == 1.0f);

                Assert.That(loadedObjs.at(1).mesh.points.size() == 100);
                Assert.That(loadedObjs.at(1).name == "LongSphereName");
                Assert.That(loadedObjs.at(1).xf.b.x == -2.0f);
