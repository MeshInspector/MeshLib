...
{
public:
    MRMESH_API EdgePathsAStarBuilder( const Mesh & mesh, VertId target, VertId start );

    MRMESH_API EdgePathsAStarBuilder( const Mesh & mesh, const MeshTriPoint & target, const MeshTriPoint & start );
};
